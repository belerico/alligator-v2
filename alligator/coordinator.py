...
class AlligatorCoordinator:
    ...
    def __init__(self, config: AlligatorConfig):
        ...
        self.feature = Feature(
            ...
            enable_llm_filtering=config.feature.enable_llm_filtering,
            llm_model=config.feature.llm_model,
            openrouter_api_key=config.feature.openrouter_api_key,
            openrouter_api_url=config.feature.openrouter_api_url,
            db_name=db_name,
            mongo_uri=mongo_uri,
